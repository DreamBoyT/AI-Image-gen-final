...
function generateImage() {
    ...
    const style = document.querySelector("#field1 .icon-button.active")?.id || "";
    const quality = document.querySelector("#field2 .icon-button.active")?.id || "";
    const size = document.querySelector("#field3 .icon-button.active")?.id || "";
    ...
    const imageContainer = document.querySelector("#card2 .card2-image-container");
...
// Select the buttons
const recycleButton = document.getElementById('recycleButtonCard2');
const deleteButton = document.getElementById('deleteButtonCard2');
const downloadButton = document.getElementById('downloadButtonCard2');

const leftArrowButtonCard3 = document.getElementById('leftArrowButtonCard3');
const rightArrowButtonCard3 = document.getElementById('rightArrowButtonCard3');
const copyButtonCard3 = document.getElementById('copyButtonCard3');
const deleteButtonCard3 = document.getElementById('deleteButtonCard3');
const downloadButtonCard3 = document.getElementById('downloadButtonCard3');

const card3ImageContainer = document.querySelector('.card3-image-container');
let card3Images = [];
...
document.querySelectorAll(".icon-button").forEach(button => {
    button.addEventListener("click", function() {
        const buttons = this.closest(".field").querySelectorAll(".icon-button");
...
recycleButton.addEventListener('click', () => {
    ...
    if (currentImageUrl) {
        ...
        card3Image.classList.add("card3-image");
...
function displayCard3Image(index) {
    ...
    if (card3Images.length > 0) {
        ...
        sampleImage.alt = "Sample Image";
        sampleImage.classList.add("card3-image");
...
downloadButtonCard3.addEventListener('click', () => {
    if (card3Images.length > 0 && currentCard3ImageIndex >= 0 && currentCard3ImageIndex < card3Images.length) {
        ...
        alert("No image to download in Card 3.");
    }
});
...
deleteButtonCard3.addEventListener('click', () => {
    if (card3Images.length > 0 && currentCard3ImageIndex >= 0 && currentCard3ImageIndex < card3Images.length) {
        ...
        alert("No image to delete in Card 3.");
    }
});
